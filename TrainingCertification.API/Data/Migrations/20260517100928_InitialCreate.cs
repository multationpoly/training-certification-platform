        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TraineeNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpertiseAreas = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassroomEquipment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassroomEquipment_Classrooms_ClassroomId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CertificationTrackCourses", x => new { x.CertificationTrackId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseSessions_InstructorProfiles_InstructorProfileId",
                        column: x => x.InstructorProfileId,
                        principalTable: "InstructorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "C#, MVC, and Azure certification path.", "Full Stack .NET Developer" },
                    { 2, "Project delivery and agile practices.", "Agile Practitioner" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Courses",
                columns: new[] { "Id", "Capacity", "CourseCategoryId", "Description", "DurationDays", "EnrollmentFee", "IsActive", "Title" },
                values: new object[,]
                {
                    { 1, 25, 1, "Programming basics using C# and .NET.", 5, 95.00m, true, "C# Fundamentals" },
                    { 2, 25, 1, "Build web applications using MVC and Razor Views.", 7, 135.00m, true, "ASP.NET Core MVC" },
                    { 3, 20, 2, "Deploy applications and databases to Azure.", 4, 120.00m, true, "Azure Essentials" },
                    { 4, 30, 3, "Scrum, planning, tracking, and team delivery.", 3, 80.00m, true, "Agile Project Management" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TraineeNumber",
                table: "AspNetUsers",
                column: "TraineeNumber",
                unique: true,
                filter: "[TraineeNumber] <> ''");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_ReferenceNumber",
                table: "Certificates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSessions_ClassroomId_StartDateTime_EndDateTime",
                table: "CourseSessions",
                columns: new[] { "ClassroomId", "StartDateTime", "EndDateTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSessions_InstructorProfileId_StartDateTime_EndDateTime",
                table: "CourseSessions",
                columns: new[] { "InstructorProfileId", "StartDateTime", "EndDateTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_TraineeId_CourseSessionId",
                table: "Enrollments",
